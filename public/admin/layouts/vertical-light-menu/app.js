            ...
            togglethemeEl.addEventListener('click', function() {
                ...
                if (parseObj.settings.layout.darkMode) {
                    ...
                    if (!getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            document.querySelector('.navbar-logo').setAttribute('src', '../../../assets/Vector.svg')
                            document.querySelector('.theme-text img').setAttribute('src', '../../../assets/SIKOKU.svg')
                            console.log(document.querySelector('.theme-text img'))
                        } else {
                    ...
                    if (getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            document.querySelector('.navbar-logo').setAttribute('src', '../../../assets/modif/Vector.svg')
                            document.querySelector('.theme-text img').setAttribute('src', '../../../assets/modif/SIKOKU.svg')
                        } else {
