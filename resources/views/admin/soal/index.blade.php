                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin-prosesTambahSoalExcel') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-12 ">
                                            <a href="https://docs.google.com/spreadsheets/d/1aCtm45ODMj8DNhtx9SCxgAlOQKE6AUj0/edit?usp=sharing&ouid=115603411936891051531&rtpof=true&sd=true" class="btn btn-primary mb-4">Download format Excel</a>
                                            <input type="hidden" name="tipe" value="{{ $tipe }}">
                                            <input type="file" name="soal" class="form-control file-upload-input" required>    
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
